...
const Home = () => {
	...
	return (
		<div>
			<div className="fixed left-0 right-0 top-0 p-4 bg-gray-50">
				<div className="flex justify-between items-center">
					...
					<button
						...
						className="border bg-indigo-600 hover:bg-indigo-700 rounded-md p-2 text-gray-100"
					>
						Add Portals
					</button>
			...
			<div className="p-10 border-t border-gray-100 bg-gray-50">
				...
				<hr />
				<p className="text-sm text-gray-400 my-1 p-2 font-bold text-center">
					Social links
				</p>
